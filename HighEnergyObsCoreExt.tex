...
\gls{HE} data include observations obtained using photon detectors covering X-ray (from X to Y MeV) through gamma-ray (from 100 MeV up to $\gtrsim$ PeV) energies, as well as cosmic-ray and astrophysical neutrino ($\gtrsim$ TeV) detectors. 
