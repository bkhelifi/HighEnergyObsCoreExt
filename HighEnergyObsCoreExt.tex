...
S & obs.event-list& To be added?  \cr
S & obs.spectrum  & To be added?  \cr
S & phys.particle.electron& Related to electron/positron  \cr
S & phys.particle.cosmicray      & Related to cosmic rays particles  \cr
P & stats.error.minus & Negative statistical error  \cr
P & stats.error.plus  & Positive statistical error  \cr
P & stat.confidenceLevel.ul & Level of confidence for a upper/lower limits computation  \cr
\sptablerule
...
\subsubsection{x-fits-gadf}
% Needs input from relevant source

\subsubsection{x-fits-vodf}
% Needs input from relevant source
